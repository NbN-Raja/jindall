...
exports.updateuserdetails = (req, res) => {
  ...
  // try {
    ...
    exports.profilepicturechange=(req,res)=>{
      ...
      const avatar = req.file.filename 
       ...
       User.findByIdAndUpdate({_id:id},{$set: {avatar: avatar}})
       .then((response)=>{
        ...
        if(!response){
          ...
          if(response.avatar) {
            ...
            const imagePath = path.join(__dirname, '../public/profile_pic', response.avatar);
